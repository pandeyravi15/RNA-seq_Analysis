...
# Transcriptomic Profiling of Mouse Models of Alzheimer’s disease (AD)

This repository contains the code for bioinformatics analyses to analyze RNA-seq data and systematically compare mouse transcriptomics data to human disease signatures from the Accelerating Medicines Partnership in Alzheimer’s Disease (AMP-AD) studies (Wan et al., 2020)[https://www.frontiersin.org/journals/aging-neuroscience/articles/10.3389/fnagi.2021.713726/full#B81].

...
# Let's do a little data housekeeping: add gene symbols
tg.counts <- tg.counts %>% 
  mutate(
...
#The human transgenes all have a counts of zero in the WT animals (where the
#transgenes are absent), while the endogenous mouse genes are expressed
#relatively consistently across both groups. We will combine the expression of
